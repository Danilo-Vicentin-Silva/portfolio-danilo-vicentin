...
const AboutMe = () => {
  return (
    <AboutMeStyle>
      ...
      <p>
        <strong>Desenvolvedor Web Front End</strong> focado em oferecer as melhores soluções web! Sempre
        utilizando as melhores técnicas e tecnologias do mercado, meu fluxo de
        trabalho é <strong>rápido e focado</strong>, busco entender os objetivos e necessidades
